...
namespace social_navigation_layers
{
  ...
  /*Defines the area that will need to be updated. We calculate the point we want to change (person.position.x +|- point, person.position.y +|- point) and then expand the min/max bounds to be sure it includes the new point */
