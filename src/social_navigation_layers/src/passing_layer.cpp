  ...
  public:
    ...
    virtual void updateCosts(costmap_2d::Costmap2D& master_grid, int min_i, int min_j, int max_i, int max_j){
      ...
      for(p_it = transformed_people_.begin(); p_it != transformed_people_.end(); ++p_it){
        ...
        /*if(!person.workstationName.compare("red")){
          factorAux = 2;
        }else if(!person.workstationName.compare("blue")){
          factorAux = 1;
        }else if(!person.workstationName.compare("green")){
          factorAux = 0;
        }else{
          factorAux = factor_;
        }*/
        ...
        double cx = person.position.x, cy = person.position.y; //Center of the person
